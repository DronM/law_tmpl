...
function DocTemplateList_Model(options){
	var id = 'DocTemplateList_Model';
	options = options || {};
	...
	options.fields.document_prefix = new FieldString("document_prefix",filed_options);
		...
		DocTemplateList_Model.superclass.constructor.call(this,id,options);
}
extend(DocTemplateList_Model,ModelXML);
