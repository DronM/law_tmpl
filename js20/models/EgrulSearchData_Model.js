...
function EgrulSearchData_Model(options){
	var id = 'EgrulSearchData_Model';
	options = options || {};
	...
	options.fields.ogrn.getValidator().setRequired(true);
	...
	options.fields.data = new FieldJSON("data",filed_options);
	...
	options.fields.update_count = new FieldInt("update_count",filed_options);
	
			
			
		EgrulSearchData_Model.superclass.constructor.call(this,id,options);
}
extend(EgrulSearchData_Model,ModelXML);
