...
$permissions = array();
					...
					$permissions['UserCatalogMetadata_Controller_insert']=TRUE;
				
					$permissions['UserCatalogMetadata_Controller_update']=TRUE;
				
					$permissions['UserCatalogMetadata_Controller_delete']=TRUE;
				
					$permissions['UserCatalogMetadata_Controller_get_list']=TRUE;
				
					$permissions['UserCatalogMetadata_Controller_get_object']=TRUE;
				
					$permissions['UserCatalogField_Controller_insert']=TRUE;
				
					$permissions['UserCatalogField_Controller_update']=TRUE;
				
					$permissions['UserCatalogField_Controller_delete']=TRUE;
				
					$permissions['UserCatalogField_Controller_get_list']=TRUE;
				
					$permissions['UserCatalogField_Controller_get_object']=TRUE;
				
					$permissions['UserCatalogData_Controller_insert']=TRUE;
				
					$permissions['UserCatalogData_Controller_update']=TRUE;
				
					$permissions['UserCatalogData_Controller_delete']=TRUE;
				
					$permissions['UserCatalogData_Controller_get_list']=TRUE;
				
					$permissions['UserCatalogData_Controller_get_object']=TRUE;
				
					$permissions['DocTemplate_Controller_insert']=TRUE;
				
					$permissions['DocTemplate_Controller_update']=TRUE;
				
					$permissions['DocTemplate_Controller_delete']=TRUE;
				
					$permissions['DocTemplate_Controller_get_list']=TRUE;
				
					$permissions['DocTemplate_Controller_get_object']=TRUE;
				
					$permissions['DocTemplate_Controller_complete']=TRUE;
				
					$permissions['DocTemplate_Controller_delete_template']=TRUE;
				
					$permissions['DocTemplate_Controller_get_template']=TRUE;
					...
					$permissions['DocAttrEvent_Controller_insert']=TRUE;
				
					$permissions['DocAttrEvent_Controller_update']=TRUE;
				
					$permissions['DocAttrEvent_Controller_delete']=TRUE;
				
					$permissions['DocAttrEvent_Controller_get_list']=TRUE;
				
					$permissions['DocAttrEvent_Controller_get_object']=TRUE;
					...
					$permissions['DocTemplateField_Controller_insert']=TRUE;
				
					$permissions['DocTemplateField_Controller_update']=TRUE;
				
					$permissions['DocTemplateField_Controller_delete']=TRUE;
				
					$permissions['DocTemplateField_Controller_get_list']=TRUE;
				
					$permissions['DocTemplateField_Controller_get_object']=TRUE;
				
					$permissions['Document_Controller_insert']=TRUE;
				
					$permissions['Document_Controller_update']=TRUE;
				
					$permissions['Document_Controller_delete']=TRUE;
				
					$permissions['Document_Controller_get_list']=TRUE;
				
					$permissions['Document_Controller_get_object']=TRUE;
				
					$permissions['Document_Controller_complete']=TRUE;
				
					$permissions['Document_Controller_process']=TRUE;
				
					$permissions['Document_Controller_get_document']=TRUE;
				
					$permissions['Document_Controller_delete_document']=TRUE;
				
					$permissions['EgrulSearchData_Controller_get_list']=TRUE;
				
					$permissions['EgrulSearchData_Controller_get_object']=TRUE;
					...
					$permissions['DataTypeFieldAlias_Controller_update']=TRUE;
				
					$permissions['DataTypeFieldAlias_Controller_delete']=TRUE;
				
					$permissions['DataTypeFieldAlias_Controller_get_list']=TRUE;
