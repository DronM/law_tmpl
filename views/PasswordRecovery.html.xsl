					...
					<form id="PasswordRecovery">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-teal text-teal"><i class="icon-spinner11"></i></div>
							...
							<div id="PasswordRecovery:submit" class="btn bg-teal btn-block">Восстановить пароль <i class="icon-arrow-left13 position-right"></i></div>
						</div>
					</form>
					<!-- /password recovery -->
